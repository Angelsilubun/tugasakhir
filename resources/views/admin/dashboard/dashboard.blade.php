        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">Total Pasien dan Pakar</div>
                            <div class="card-body">
                                <div class="chart-container" style="height: 300px;">
        ...
        <script>
            ...
            new Chart(ctxGejala, {
                ...
                options: {
                    ...
                    //     title: {
                    //         display: true,
                    //         text: 'Grafik Gejala yang Paling Banyak Dijawab oleh Pasien',
                    //         padding: {
                    //             top: 10,
                    //             bottom: 30
                    //         },
            ...
            new Chart(ctxPenyakit, {
                ...
                options: {
                    ...
                    //     title: {
                    //         display: true,
                    //         text: 'Grafik Penyakit yang Paling Banyak Dialami Pasien',
                    //         padding: {
                    //             top: 10,
                    //             bottom: 30
                    //         },
        ...
        <script>
            ...
            new Chart(ctx, {
                ...
                options: {
                    ...
                    //     title: {
                    //         display: true,
                    //         text: 'Grafik Jumlah Pasien Berdasarkan Bulan dan Tahun',
                    //         padding: {
                    //             top: 10,
                    //             bottom: 30
                    //         },
